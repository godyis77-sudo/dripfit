...
import { Camera, Crown, Shield, Sparkles, Users, Ruler, Star, ChevronRight, TrendingUp, Share2, Gift, ChevronUp } from 'lucide-react';
...
const stagger = {
  ...
  item: {
    ...
    animate: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.6, ease: [0.16, 1, 0.3, 1] as const } },
  },
};
      ...
      >
        ...
        <motion.div variants={stagger.item} className="w-full max-w-[340px] mb-3">
          <Button
            ...
            variant="luxury"
            className="w-full h-14 text-[13px] font-bold uppercase tracking-[0.18em] rounded-2xl active:scale-[0.97] transition-transform shimmer-sweep"
            size="lg"
          >
        ...
        <motion.div variants={stagger.item} className="w-full max-w-[340px] mb-10">
          ...
          >
            <div className="h-10 w-10 icon-3d shrink-0">
              <Gift className="h-4.5 w-4.5 text-primary shimmer-icon" />
            </div>
            <div className="flex-1 text-left">
