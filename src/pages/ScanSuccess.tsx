...
const OVERLAYS: MeasurementOverlay[] = [
  {
    ...
    label: 'HEIGHT',
    side: 'left',
    // No shared baseline for height in BodyDiagram, keep tuned for this asset
    valTop: '12%',
    // This is the distance from the TOP of the baked-in label to the TOP of our value block
    // (label height + requested 6px gap)
    offset: 17,
    delay: 0,
  ...
  },
  {
    ...
    label: 'SHOULDER',
    side: 'right',
    // Matches BodyDiagram labelTop (calibrated to scanResultsFull)
    valTop: '18.9%',
    offset: 17,
    delay: 0.15,
