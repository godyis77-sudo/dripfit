...
const AnimatedSilhouette = () => (
  ...
  >
    <div className="overflow-hidden rounded-[1rem] border-[3px] border-primary ring-[2px] ring-inset ring-black" style={{ boxShadow: '0 0 16px 6px hsl(45 88% 50% / 0.7), 0 0 50px 18px hsl(45 88% 45% / 0.35), 0 0 90px 30px hsl(45 88% 40% / 0.15), inset 0 0 14px 3px hsl(45 88% 50% / 0.2)' }}>
      <img
