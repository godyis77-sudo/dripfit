...
const Browse = () => {
  ...
  const activeFilterCount = (retailerFilter ? 1 : 0) + (genreFilter ? 1 : 0) + (fitFilter ? 1 : 0) + (sort !== 'default' ? 1 : 0) + (genderFilter !== 'all' ? 1 : 0);
        ...
        {filtersOpen && (
          ...
          >
            <div className="px-4 py-3 space-y-3">
              ...
              {activeFilterCount > 0 && (
                <button
                  onClick={() => { setSort('default'); setRetailerFilter(null); setGenreFilter(null); setFitFilter(null); }}
