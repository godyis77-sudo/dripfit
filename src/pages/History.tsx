    ...
    <div className="min-h-screen bg-background px-4 pt-4 pb-safe-tab">
      <div>
        <div className="flex items-center gap-2 mb-4">
          <Button variant="ghost" size="icon" onClick={() => navigate('/')} className="h-10 w-10 rounded-lg min-h-[44px] min-w-[44px]" aria-label="Go back">
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center justify-between mb-1.5">
                        ...
                        <div className="flex items-center gap-1.5">
                          <span className="text-[11px] pill pill-filled px-2 py-0.5 rounded-md">{m.sizeRecommendation}</span>
