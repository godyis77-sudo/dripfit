...
const measurementLines: MeasurementLine[] = [
  ...
  { key: 'waist', label: 'Waist', labelSide: 'right', x1: '42%', y1: '43.5%', x2: '58%', y2: '43.5%', labelTop: '40%', labelEdgeX: 85, leaderX: 58, leaderY: 41.5 },
  { key: 'hips', label: 'Hips', labelSide: 'right', x1: '39%', y1: '50.5%', x2: '61%', y2: '50.5%', labelTop: '51%', labelEdgeX: 88, leaderX: 61, leaderY: 52.5 },
