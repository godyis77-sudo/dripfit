...
const measurementLines: MeasurementLine[] = [
  { key: 'shoulder', label: 'Shoulder', labelSide: 'right', x1: '33%', y1: '24.5%', x2: '67%', y2: '24.5%', labelTop: '23%', labelEdgeX: 81, leaderX: 69, leaderY: 24.5 },
  { key: 'chest', label: 'Chest', labelSide: 'left', x1: '38%', y1: '27%', x2: '62%', y2: '27%', labelTop: '25%', labelEdgeX: 14, leaderX: 36, leaderY: 26.5 },
  ...
  { key: 'inseam', label: 'Inseam', labelSide: 'left', x1: '48%', y1: '55%', x2: '45%', y2: '86%', labelTop: '69%', labelEdgeX: 16, leaderX: 44, leaderY: 70.5 },
];
