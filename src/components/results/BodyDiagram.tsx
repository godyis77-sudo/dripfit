      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <motion.div
            ...
            style={{ background: 'radial-gradient(ellipse 100% 90% at 50% 42%, hsl(220 18% 7%) 0%, hsl(220 16% 5%) 70%, hsl(220 14% 4%) 100%)' }}
          ...
          >
            <div className="relative h-[116%] w-[92%] max-w-[360px]">
              ...
              {/* ═══ 3D DEPTH LAYERS — rendered above glow, below main silhouette ═══ */}
              ...
              {/* Layer 4: Bright gold bloom offset behind */}
              <motion.img
                src={silhouetteSrc}
                alt="" aria-hidden="true"
                className="absolute inset-0 h-full w-full object-contain pointer-events-none"
