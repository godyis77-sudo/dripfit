...
const measurementLines: MeasurementLine[] = [
  ...
  { key: 'chest', label: 'Chest', labelSide: 'left', x1: '38%', y1: '27%', x2: '62%', y2: '27%', labelTop: '25%', labelEdgeX: 5, leaderX: 38, leaderY: 26.5 },
  ...
  { key: 'sleeve', label: 'Sleeve', labelSide: 'left', x1: '36%', y1: '23%', x2: '28%', y2: '53%', labelTop: '36%', labelEdgeX: 5, leaderX: 32, leaderY: 37.5 },
  { key: 'inseam', label: 'Inseam', labelSide: 'left', x1: '48%', y1: '55%', x2: '45%', y2: '86%', labelTop: '69%', labelEdgeX: 5, leaderX: 46, leaderY: 70.5 },
];
