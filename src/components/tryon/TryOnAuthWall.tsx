    ...
    >
      ...
      >
        ...
        <p className="text-[13px] text-muted-foreground text-center mb-5">
          {isAuthenticatedDailyLimit
            ? `You've used all ${FREE_DAILY_LIMIT} free try-ons for today. Go Premium for unlimited try-ons, every day.`
            : reason === 'guest_limit'
              ? `Create a free account to get ${FREE_DAILY_LIMIT} try-ons per day — plus save your looks and get size recommendations.`
              : `Upgrade to Premium for unlimited try-ons, or come back tomorrow for ${FREE_DAILY_LIMIT} more.`}
        </p>
          ...
          {isAuthenticatedDailyLimit ? (
            ...
            <>
              {[
                ...
                `${FREE_DAILY_LIMIT} free try-ons per day`,
        ...
        >
          {isAuthenticatedDailyLimit ? 'Come back tomorrow' : 'Maybe later'}
        </button>
      </motion.div>
    </motion.div>
  );
