      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-muted-foreground/80 max-w-md mx-auto">
            ...
            Reply <span className="text-primary font-mono">B</span> or <span className="text-primary font-mono">C</span> — or pick a combo (e.g. <span className="text-primary font-mono">B hero, C cta</span>).
          </p>
        </div>
        ...
        <div className="space-y-10">
          {SAMPLES.map((s) => (
            ...
            >
              ...
              <div className="mb-2 text-[10px] tracking-[.2em] uppercase font-mono text-muted-foreground/50">
                Hero
              </div>
              <h3
