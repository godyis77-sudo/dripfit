        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          >
            ...
            <div className="text-left">
              <span className="block text-[13px] font-extrabold tracking-tight text-primary-foreground drop-shadow-[0_1px_2px_hsl(var(--foreground)/0.25)] leading-tight">Size Guide</span>
