...
const DecorativeSilhouette = ({ className = '', height = 200 }: Props) => (
  <div className={`relative overflow-hidden rounded-[4rem] border-[10px] ${className}`} style={{ width: height * (2 / 3), height, borderColor: 'hsl(42 45% 35%)' }}>
    <img
      src={bodySilhouette}
    ...
    <div className="absolute top-[2%] left-0 right-0 flex justify-center">
      <p className="text-[15px] font-extrabold uppercase tracking-[0.2em] leading-none" style={{ color: 'hsl(42 45% 35%)' }}>Scan Results</p>
    </div>
