...
const BrandLogo = ({ size = 'sm', className, iconOnly = false }: BrandLogoProps) => {
  ...
  return (
    <div className={cn('flex items-center', s.gap, className)}>
      <img src={iconCrown} alt="DripFit crown" className="object-contain mix-blend-lighten drop-shadow-[0_2px_6px_hsl(var(--drip-gold)/0.4)] shrink-0" style={{ width: s.icon, height: s.icon }} />
      {!iconOnly && (
