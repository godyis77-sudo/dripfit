                ...
                >
                  <div className="relative">
                    ...
                    {(() => {
                      ...
                      return displayBrand ? (
                        <div className="absolute bottom-1.5 right-1.5 bg-primary rounded px-1.5 py-px shadow-lg border border-primary-foreground/20 leading-none">
                          <span className="text-[8px] font-extrabold text-primary-foreground uppercase tracking-wide leading-none">{displayBrand}</span>
                        </div>
                      ) : null;
                    })()}
                  </div>
