...
const ROW2 = ['OFF-WHITE', 'STÜSSY', 'FEAR OF GOD', 'AMIRI', 'BALENCIAGA', 'STONE ISLAND', 'PALM ANGELS'];
const ROW3 = ['BAPE', 'UNIQLO', 'CARHARTT', 'NEW BALANCE', 'ADIDAS', 'TOMMY HILFIGER', 'RALPH LAUREN'];
