CREATE OR REPLACE FUNCTION public.get_filtered_catalog(
  p_categories text[] DEFAULT NULL,
  p_brand text DEFAULT NULL,
  p_gender text DEFAULT NULL,
  p_genre text DEFAULT NULL,
  p_fit_profile text DEFAULT NULL,
  p_retailer text DEFAULT NULL,
  p_price_min_cents int DEFAULT NULL,
  p_price_max_cents int DEFAULT NULL,
  p_min_confidence numeric DEFAULT 0.05,
